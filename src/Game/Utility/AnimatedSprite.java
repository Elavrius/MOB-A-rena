...
/*
 * Class for animated Sprites, that contains array of images and will play them in order
...
public class AnimatedSprite extends Sprite {
	...
	private int currentFrame = 0; //number of the current rendered frame
	private int maxFrame;//how many frames at all there is
	private int renderCounter = 0;//counter that checks how many frames till actual image change
	private int frameIterator = 1;//is +1 or -1, if sprite is reversed it will set will order increase or decrease

	ArrayList<Image> sprite;//contains all images of the sprite

	//Constructor.
	public AnimatedSprite(String path, int width, int height, int x, int y, int amount) {
		super(path);
