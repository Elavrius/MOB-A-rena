...
/*
 * This class creates scene where You will choose Champion 
 * from list of available Champions
*/
public class PickHeroScene extends Scene{
	Team team;
	int number;
	...
	public PickHeroScene(Scene previousScene, Group root, Team team, int nr) {
		super(root, 800, 600);
		...
		buttons[0]=b1=new SetChampionButton(this, team, nr, "Witch", 20, 20);
		buttons[1]=b2=new SetChampionButton(this, team, nr, "Bruno", 150, 20);
